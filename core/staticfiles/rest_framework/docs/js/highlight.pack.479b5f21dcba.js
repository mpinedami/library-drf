!(function (e) {
  ...
  function s(e, t, a, i) {
    ...
    function g(e, n) {
      const t = E.cI ? n[0].toLowerCase() : n[0];
    ...
    function h() {
      ...
      const e = L.sL ? s(L.sL, y, !0, M[L.sL]) : l(y);
      return (
        L.r > 0 && (B += e.r),
...
hljs.registerLanguage("objectivec", function (e) {
  const t = { cN: "built_in", b: "(AV|CA|CF|CG|CI|MK|MP|NS|UI)\\w+" };
  const i = {
    keyword:
...
hljs.registerLanguage("d", function (e) {
  ...
  const t = "(0|[1-9][\\d_]*)";
  const a = "(0|[1-9][\\d_]*|\\d[\\d_]*|[\\d_]+?\\d)";
  const i = "0[bB][01_]+";
  const n = "([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*)";
  const c = "0[xX]" + n;
  const _ = "([eE][+-]?" + a + ")";
  const d =
    "(" + a + "(\\.\\d*|" + _ + ")|\\d+\\." + a + a + "|\\." + t + _ + "?)";
  const o = "(0[xX](" + n + "\\." + n + "|\\.?" + n + ")[pP][+-]?" + a + ")";
  const s = "(" + t + "|" + i + "|" + c + ")";
  const l = "(" + o + "|" + d + ")";
  const u =
    "\\\\(['\"\\?\\\\abfnrtv]|u[\\dA-Fa-f]{4}|[0-7]{1,3}|x[\\dA-Fa-f]{2}|U[\\dA-Fa-f]{8})|&[a-zA-Z\\d]{2,};";
  const b = { cN: "number", b: "\\b" + s + "(L|u|U|Lu|LU|uL|UL)?", r: 0 };
  const f = {
    cN: "number",
    b: "\\b(" + l + "([fF]|L|i|[fF]i|Li)?|" + s + "(i|[fF]i|Li))",
    r: 0,
  };
  const g = { cN: "string", b: "'(" + u + "|.)", e: "'", i: "." };
  const h = { b: u, r: 0 };
  const p = { cN: "string", b: '"', c: [h], e: '"[cwd]?' };
  const w = { cN: "string", b: '[rq]"', e: '"[cwd]?', r: 5 };
  const N = { cN: "string", b: "`", e: "`[cwd]?" };
  const A = { cN: "string", b: 'x"[\\da-fA-F\\s\\n\\r]*"[cwd]?', r: 10 };
  const F = { cN: "string", b: 'q"\\{', e: '\\}"' };
  const m = { cN: "shebang", b: "^#!", e: "$", r: 5 };
  const y = { cN: "preprocessor", b: "#(line)", e: "$", r: 5 };
  const L = { cN: "keyword", b: "@[a-zA-Z_][a-zA-Z_\\d]*" };
  const v = e.C("\\/\\+", "\\+\\/", { c: ["self"], r: 10 });
  return {
    l: e.UIR,
    k: r,
...
hljs.registerLanguage("actionscript", function (e) {
  ...
  const t = { cN: "rest_arg", b: "[.]{3}", e: a, r: 10 };
  return {
    aliases: ["as"],
    k: {
      keyword:
...
hljs.registerLanguage("tex", function (c) {
  const e = { cN: "command", b: "\\\\[a-zA-Zа-яА-я]+[\\*]?" };
  const m = { cN: "command", b: "\\\\[^a-zA-Zа-яА-я0-9]" };
  const r = { cN: "special", b: "[{}\\[\\]\\&#~]", r: 0 };
  return {
    c: [
      {
        b:
...
hljs.registerLanguage("haskell", function (e) {
  const c = [e.C("--", "$"), e.C("{-", "-}", { c: ["self"] })];
  const a = { cN: "pragma", b: "{-#", e: "#-}" };
  const i = { cN: "preprocessor", b: "^#", e: "$" };
  const n = { cN: "type", b: "\\b[A-Z][\\w']*", r: 0 };
  const t = {
    cN: "container",
    b: "\\(",
    e: "\\)",
  ...
  const l = { cN: "container", b: "{", e: "}", c: t.c };
  return {
    aliases: ["hs"],
    k:
...
hljs.registerLanguage("matlab", function (e) {
  const a = [e.CNM, { cN: "string", b: "'", e: "'", c: [e.BE, { b: "''" }] }];
  const s = { r: 0, c: [{ cN: "operator", b: /'['\.]*/ }] };
  return {
    k: {
      keyword:
...
hljs.registerLanguage("xl", function (e) {
  ...
  const a = { cN: "constant", b: "[A-Z][A-Z_0-9]+", r: 0 };
  const r = { cN: "variable", b: "([A-Z][a-z_0-9]+)+", r: 0 };
  const i = { cN: "id", b: "[a-z][a-z_0-9]+", r: 0 };
  const l = { cN: "string", b: '"', e: '"', i: "\\n" };
  const n = { cN: "string", b: "'", e: "'", i: "\\n" };
  const s = { cN: "string", b: "<<", e: ">>" };
  const c = {
    cN: "number",
...
hljs.registerLanguage("scala", function (e) {
  const t = { cN: "annotation", b: "@[A-Za-z]+" };
  const a = { cN: "string", b: 'u?r?"""', e: '"""', r: 10 };
  const r = { cN: "symbol", b: "'\\w[\\w\\d_]*(?!')" };
  const c = { cN: "type", b: "\\b[A-Z][A-Za-z0-9_]*", r: 0 };
  const i = {
    cN: "title",
    b: /[^0-9\n\t "'(),.`{}\[\]:;][^\n\t "'(),.`{}\[\]:;]+|[^0-9\n\t "'(),.`{}\[\]:;=]/,
    r: 0,
  ...
  const n = { cN: "function", bK: "def val", e: /[:={\[(\n;]/, c: [i] };
  return {
    k: {
      literal: "true false null",
      keyword:
...
hljs.registerLanguage("julia", function (r) {
  ...
  const o = { l: t, k: e };
  const n = { cN: "type-annotation", b: /::/ };
  const a = { cN: "subtype", b: /<:/ };
  const i = {
    cN: "number",
    b: /(\b0x[\d_]*(\.[\d_]*)?|0x\.\d[\d_]*)p[-+]?\d+|\b0[box][a-fA-F0-9][a-fA-F0-9_]*|(\b\d[\d_]*(\.[\d_]*)?|\.\d[\d_]*)([eEfF][-+]?\d+)?/,
    r: 0,
  };
  const l = { cN: "char", b: /'(.|\\[xXuU][a-zA-Z0-9]+)'/ };
  const c = { cN: "subst", b: /\$\(/, e: /\)/, k: e };
  const u = { cN: "variable", b: "\\$" + t };
  const d = {
    cN: "string",
    c: [r.BE, c, u],
    v: [
  ...
  const g = { cN: "string", c: [r.BE, c, u], b: "`", e: "`" };
  const s = { cN: "macrocall", b: "@" + t };
  const S = {
    cN: "comment",
    v: [
      { b: "#=", e: "=#", r: 10 },
...
hljs.registerLanguage("delphi", function (e) {
  ...
  const t = [e.CLCM, e.C(/\{/, /\}/, { r: 0 }), e.C(/\(\*/, /\*\)/, { r: 10 })];
  const i = { cN: "string", b: /'/, e: /'/, c: [{ b: /''/ }] };
  const c = { cN: "string", b: /(#\d+)+/ };
  const o = { b: e.IR + "\\s*=\\s*class\\s*\\(", rB: !0, c: [e.TM] };
  const n = {
    cN: "function",
...
hljs.registerLanguage("json", function (e) {
  ...
  const i = [e.QSM, e.CNM];
  const l = { cN: "value", e: ",", eW: !0, eE: !0, c: i, k: t };
  const c = {
    b: "{",
    e: "}",
    c: [
...
hljs.registerLanguage("swift", function (e) {
  ...
  const t = { cN: "type", b: "\\b[A-Z][\\w']*", r: 0 };
  const n = e.C("/\\*", "\\*/", { c: ["self"] });
  const r = { cN: "subst", b: /\\\(/, e: "\\)", k: i, c: [] };
  const s = {
    cN: "number",
    b:
  ...
  const o = e.inherit(e.QSM, { c: [r, e.BE] });
  return (
    (r.c = [s]),
    {
      k: i,
...
hljs.registerLanguage("lisp", function (b) {
  ...
  const a = { cN: "shebang", b: "^#!", e: "$" };
  const i = { cN: "literal", b: "\\b(t{1}|nil)\\b" };
  const l = {
    cN: "number",
    v: [
      { b: r, r: 0 },
  ...
  const t = b.inherit(b.QSM, { i: null });
  const d = b.C(";", "$", { r: 0 });
  const n = { cN: "variable", b: "\\*", e: "\\*" };
  const u = { cN: "keyword", b: "[:&]" + e };
  const N = { b: e, r: 0 };
  const o = { b: c };
  const s = { b: "\\(", e: "\\)", c: ["self", i, t, l, N] };
  const v = {
    cN: "quoted",
    c: [l, t, n, u, s, N],
    v: [
...
hljs.registerLanguage("scheme", function (e) {
  ...
  const n = { cN: "shebang", b: "^#!", e: "$" };
  const c = { cN: "literal", b: "(#t|#f|#\\\\" + t + "|#\\\\.)" };
  const l = {
    cN: "number",
    v: [
      { b: r, r: 0 },
...
hljs.registerLanguage("php", function (e) {
  const c = { cN: "variable", b: "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*" };
  const i = { cN: "preprocessor", b: /<\?(php)?|\?>/ };
  const a = {
    cN: "string",
    c: [e.BE, i],
    v: [
...
hljs.registerLanguage("lua", function (e) {
  const t = "\\[=*\\[";
  const a = "\\]=*\\]";
  const r = { b: t, e: a, c: ["self"] };
  const n = [e.C("--(?!" + t + ")", "$"), e.C("--" + t, a, { c: [r], r: 10 })];
  return {
    l: e.UIR,
    k: {
      keyword:
...
hljs.registerLanguage("gcode", function (e) {
  ...
  const r = { cN: "preprocessor", b: "([O])([0-9]+)" };
  const l = [
    e.CLCM,
    e.CBCM,
    e.C(/\(/, /\)/),
...
hljs.registerLanguage("livescript", function (e) {
  ...
  const s = "[A-Za-z$_](?:-[0-9A-Za-z$_]|[0-9A-Za-z$_])*";
  const i = e.inherit(e.TM, { b: s });
...
hljs.registerLanguage("monkey", function (e) {
  const n = { cN: "number", r: 0, v: [{ b: "[$][a-fA-F0-9]+" }, e.NM] };
  return {
    cI: !0,
    k: {
      keyword:
...
hljs.registerLanguage("erlang", function (e) {
  ...
  const o = { cN: "tuple", b: "{", e: "}", r: 0 };
  const t = { cN: "variable", b: "\\b_([A-Z][A-Za-z0-9_]*)?", r: 0 };
  const l = { cN: "variable", b: "[A-Z][a-zA-Z0-9_]*", r: 0 };
  const f = {
    b: "#" + e.UIR,
    r: 0,
    rB: !0,
  ...
  const s = { bK: "fun receive if try case", e: "end", k: a };
  s.c = [n, b, e.inherit(e.ASM, { cN: "" }), s, d, e.QSM, i, o, t, l, f];
  const u = [n, b, s, d, e.QSM, i, o, t, l, f];
  (d.c[1].c = u), (o.c = u), (f.c[1].c = u);
  const v = { cN: "params", b: "\\(", e: "\\)", c: u };
  return {
    aliases: ["erl"],
    k: a,
    i: "(</|\\*=|\\+=|-=|/\\*|\\*/|\\(\\*|\\*\\))",
...
hljs.registerLanguage("stylus", function (t) {
  const e = { cN: "variable", b: "\\$" + t.IR };
  const o = { cN: "hexcolor", b: "#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})", r: 10 };
  const i = [
    "charset",
    "css",
    "debug",
...
hljs.registerLanguage("css", function (e) {
  ...
  const a = { cN: "function", b: c + "\\(", rB: !0, eE: !0, e: "\\(" };
  const r = {
    cN: "rule",
    b: /[A-Z\_\.\-]+\s*:/,
    rB: !0,
...
hljs.registerLanguage("ruby", function (e) {
  ...
  const b = { cN: "yardoctag", b: "@[A-Za-z]+" };
  const a = { cN: "value", b: "#<", e: ">" };
  const n = [
    e.C("#", "$", { c: [b] }),
    e.C("^\\=begin", "^\\=end", { c: [b], r: 10 }),
    e.C("^__END__", "\\n$"),
  ];
  const s = { cN: "subst", b: "#\\{", e: "}", k: r };
  const t = {
    cN: "string",
    c: [e.BE, s],
    v: [
...
hljs.registerLanguage("mercury", function (e) {
  ...
  const r = { cN: "label", b: "XXX", e: "$", eW: !0, r: 0 };
  const t = e.inherit(e.CLCM, { b: "%" });
  const _ = e.inherit(e.CBCM, { r: 0 });
  t.c.push(r), _.c.push(r);
  const n = { cN: "number", b: "0'.\\|0[box][0-9a-fA-F]*" };
  const a = e.inherit(e.ASM, { r: 0 });
  const o = e.inherit(e.QSM, { r: 0 });
  const l = {
    cN: "constant",
...
hljs.registerLanguage("clojure", function (e) {
  ...
  const a = "[-+]?\\d+(\\.\\d+)?";
  const o = { b: n, r: 0 };
  const s = { cN: "number", b: a, r: 0 };
  const i = e.inherit(e.QSM, { i: null });
  const c = e.C(";", "$", { r: 0 });
  const d = { cN: "literal", b: /\b(true|false|nil)\b/ };
  const l = { cN: "collection", b: "[\\[\\{]", e: "[\\]\\}]" };
  const m = { cN: "comment", b: "\\^" + n };
  const p = e.C("\\^\\{", "\\}");
  const u = { cN: "attribute", b: "[:]" + n };
  const f = { cN: "list", b: "\\(", e: "\\)" };
  const h = { eW: !0, r: 0 };
  const y = { k: t, l: n, cN: "keyword", b: n, starts: h };
  const b = [f, i, m, p, c, u, l, s, d, o];
  return (
    (f.c = [e.C("comment", ""), y, h]),
    (h.c = b),
    (l.c = b),
...
hljs.registerLanguage("twig", function (e) {
  ...
  const r = { cN: "function", bK: a, r: 0, c: [t] };
  const c = {
    cN: "filter",
    b: /\|[A-Za-z_]+:?/,
    k:
...
hljs.registerLanguage("livecodeserver", function (e) {
  ...
  const t = [e.CBCM, e.HCM, e.C("--", "$"), e.C("[^:]//", "$")];
  const a = e.inherit(e.TM, {
    v: [{ b: "\\b_*rig[A-Z]+[A-Za-z0-9_\\-]*" }, { b: "\\b_[a-z0-9\\-]+" }],
  });
  const o = e.inherit(e.TM, { b: "\\b([A-Za-z0-9_\\-]+)\\b" });
  return {
    cI: !1,
    k: {
      keyword:
...
hljs.registerLanguage("step21", function (e) {
  ...
  const i = "END-ISO-10303-21;";
  const l = { literal: "", built_in: "", keyword: "HEADER ENDSEC DATA" };
  const s = { cN: "preprocessor", b: "ISO-10303-21;", r: 10 };
  const t = [
    e.CLCM,
    e.CBCM,
    e.C("/\\*\\*!", "\\*/"),
...
hljs.registerLanguage("python", function (e) {
  ...
  const c = { cN: "params", b: /\(/, e: /\)/, c: ["self", r, l, b] };
  return {
    aliases: ["py", "gyp"],
    k: {
      keyword:
...
hljs.registerLanguage("nix", function (e) {
  ...
  const i = { cN: "subst", b: /\$\{/, e: /}/, k: t };
  const r = { cN: "variable", b: /[a-zA-Z0-9-_]+(\s*=)/ };
  const n = { cN: "string", b: "''", e: "''", c: [i] };
  const s = { cN: "string", b: '"', e: '"', c: [i] };
  const a = [e.NM, e.HCM, e.CBCM, n, s, r];
...
hljs.registerLanguage("1c", function (c) {
  const e = "[a-zA-Zа-яА-Я][a-zA-Z0-9_а-яА-Я]*";
  const r =
...
hljs.registerLanguage("fsharp", function (e) {
  const t = { b: "<", e: ">", c: [e.inherit(e.TM, { b: /'[a-zA-Z0-9_]+/ })] };
  return {
    aliases: ["fs"],
    k:
...
hljs.registerLanguage("r", function (e) {
  const r = "([a-zA-Z]|\\.[a-zA-Z.])[a-zA-Z0-9._]*";
  return {
    c: [
      e.HCM,
      {
...
hljs.registerLanguage("nsis", function (e) {
  ...
  const n = { cN: "constant", b: "\\$+{[a-zA-Z0-9_]+}" };
  const i = { cN: "variable", b: "\\$+[a-zA-Z0-9_]+", i: "\\(\\){}" };
  const r = { cN: "constant", b: "\\$+\\([a-zA-Z0-9_]+\\)" };
  const o = {
    cN: "params",
    b:
...
hljs.registerLanguage("less", function (e) {
  ...
  const o = c.concat({ b: "{", e: "}", c: a });
  const u = { bK: "when", eW: !0, c: [{ bK: "and not" }].concat(c) };
  const C = {
    cN: "attribute",
    b: t,
    e: ":",
...
hljs.registerLanguage("pf", function (t) {
  const o = { cN: "variable", b: /\$[\w\d#@][\w\d_]*/ };
  const e = { cN: "variable", b: /</, e: />/ };
  return {
    aliases: ["pf.conf"],
    l: /[a-z0-9_<>-]+/,
    k: {
...
hljs.registerLanguage("lasso", function (e) {
  ...
  const i = { cN: "preprocessor", b: "\\[/noprocess|" + a };
  const l = { cN: "variable", b: "'" + r + "'" };
  const c = [
    e.CLCM,
...
hljs.registerLanguage("prolog", function (c) {
  const r = { cN: "atom", b: /[a-z][A-Za-z0-9_]*/, r: 0 };
  const b = {
    cN: "name",
  ...
  const a = { b: /\(/, e: /\)/, r: 0 };
  const e = { b: /\[/, e: /\]/ };
  const n = { cN: "comment", b: /%/, e: /$/, c: [c.PWM] };
  const t = { cN: "string", b: /`/, e: /`/, c: [c.BE] };
  const g = { cN: "string", b: /0\'(\\\'|.)/ };
  const N = { cN: "string", b: /0\'\\s/ };
  const o = { b: /:-/ };
  const s = [r, b, a, o, e, n, c.CBCM, c.QSM, c.ASM, t, g, N, c.CNM];
...
hljs.registerLanguage("oxygene", function (e) {
  ...
  const t = e.C("{", "}", { r: 0 });
  const a = e.C("\\(\\*", "\\*\\)", { r: 10 });
  const n = { cN: "string", b: "'", e: "'", c: [{ b: "''" }] };
  const o = { cN: "string", b: "(#\\d+)+" };
  const i = {
    cN: "function",
...
hljs.registerLanguage("applescript", function (e) {
  const t = e.inherit(e.QSM, { i: "" });
  const r = { cN: "params", b: "\\(", e: "\\)", c: ["self", e.CNM, t] };
  const o = e.C("--", "$");
  const n = e.C("\\(\\*", "\\*\\)", { c: ["self", o] });
  const a = [o, n, e.HCM];
  return {
    aliases: ["osascript"],
    k: {
...
hljs.registerLanguage("makefile", function (e) {
  const a = { cN: "variable", b: /\$\(/, e: /\)/, c: [e.BE] };
  return {
    aliases: ["mk", "mak"],
    c: [
      e.HCM,
...
hljs.registerLanguage("dust", function (e) {
  const a = "if eq ne lt lte gt gte select default math sep";
  return {
    aliases: ["dst"],
    cI: !0,
    sL: "xml",
