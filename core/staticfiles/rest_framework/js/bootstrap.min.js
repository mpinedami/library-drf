...
!(function (t) {
  ...
  (function (s) {
    ...
    function i(o) {
      return this.each(function () {
        const t = s(this);
        let e = t.data("bs.button");
        const i = "object" == typeof o && o;
  ...
  (function (p) {
    ...
    function r(n) {
      return this.each(function () {
        const t = p(this);
        let e = t.data("bs.carousel");
        const i = p.extend({}, c.DEFAULTS, t.data(), "object" == typeof n && n);
        const o = "string" == typeof n ? n : i.slide;
    ...
    (c.VERSION = "3.4.1"),
      ...
      (c.prototype.getItemForDirection = function (t, e) {
        ...
        if (
          ...
          return e;
        const o = (i + ("prev" == t ? -1 : 1)) % this.$items.length;
        return this.$items.eq(o);
      }),
      (c.prototype.to = function (t) {
        const e = this;
        const i = this.getItemIndex(
      ...
      (c.prototype.slide = function (t, e) {
        ...
        const o = e || this.getItemForDirection(t, i);
        const n = this.interval;
        const s = "next" == t ? "left" : "right";
        const a = this;
        if (o.hasClass("active")) return (this.sliding = !1);
        const r = o[0];
        const l = p.Event("slide.bs.carousel", {
          relatedTarget: r,
          direction: s,
        });
    ...
    const e = function (t) {
      ...
      let i = e.attr("href");
      i && (i = i.replace(/.*(?=#[^\s]+$)/, ""));
      const o = e.attr("data-target") || i;
      const n = p(document).find(o);
      if (n.hasClass("carousel")) {
        const s = p.extend({}, n.data(), e.data());
        const a = e.attr("data-slide-to");
        a && (s.interval = !1),
          r.call(n, s),
  ...
  (function (a) {
    ...
    function l(o) {
      return this.each(function () {
        const t = a(this);
        let e = t.data("bs.collapse");
        const i = a.extend({}, r.DEFAULTS, t.data(), "object" == typeof o && o);
    ...
    (a.fn.collapse = l),
      ...
      a(document).on(
        ...
        function (t) {
          ...
          const i = n(e);
          const o = i.data("bs.collapse") ? "toggle" : e.data();
          l.call(i, o);
        }
      );
  })(jQuery),
  ...
  (function (a) {
    ...
    function r(o, n) {
      return this.each(function () {
        const t = a(this);
        let e = t.data("bs.modal");
        const i = a.extend({}, s.DEFAULTS, t.data(), "object" == typeof o && o);
    ...
    (s.VERSION = "3.4.1"),
      ...
      (s.prototype.show = function (i) {
        const o = this;
        const t = a.Event("show.bs.modal", { relatedTarget: i });
      ...
      (s.prototype.backdrop = function (t) {
        const e = this;
        const i = this.$element.hasClass("fade") ? "fade" : "";
    ...
    (a.fn.modal = r),
      ...
      a(document).on(
        ...
        function (t) {
          ...
          const n = a(document).find(o);
          const s = n.data("bs.modal")
            ? "toggle"
  ...
  (function (g) {
    ...
    const l = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[a-z0-9+/]+=*$/i;
    function u(t, e) {
    ...
    function n(t, e, i) {
      ...
      for (
        ...
        const l = s[a];
        const h = l.nodeName.toLowerCase();
        if (-1 !== g.inArray(h, n))
          for (
            let d = g.map(l.attributes, function (t) {
                return t;
              }),
              p = [].concat(e["*"] || [], e[h] || []),
              c = 0,
    ...
    (m.VERSION = "3.4.1"),
      ...
      (m.prototype.init = function (t, e, i) {
        ...
        for (let o = this.options.trigger.split(" "), n = o.length; n--; ) {
          ...
          if ("click" == s)
            ...
            const r = "hover" == s ? "mouseleave" : "focusout";
            this.$element.on(
              a + "." + this.type,
              this.options.selector,
      ...
      (m.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          const h = o[0].offsetWidth;
          const d = o[0].offsetHeight;
          if (r) {
            const p = s;
            const c = this.getPosition(this.$viewport);
            (s =
      ...
      (m.prototype.applyPlacement = function (t, e) {
        ...
        isNaN(s) && (s = 0),
          ...
          i.addClass("in");
        const r = i[0].offsetWidth;
        const l = i[0].offsetHeight;
        "top" == e && l != n && (t.top = t.top + n - l);
        const h = this.getViewportAdjustedDelta(e, t, r, l);
        h.left ? (t.left += h.left) : (t.top += h.top);
        const d = /top|bottom/.test(e);
        const p = d ? 2 * h.left - o + r : 2 * h.top - n + l;
        const c = d ? "offsetWidth" : "offsetHeight";
      ...
      (m.prototype.hide = function (t) {
        const e = this;
        const i = g(this.$tip);
        const o = g.Event("hide.bs." + this.type);
        function n() {
      ...
      (m.prototype.getPosition = function (t) {
        const e = (t = t || this.$element)[0];
        const i = "BODY" == e.tagName;
        ...
        const n = window.SVGElement && e instanceof window.SVGElement;
        const s = i ? { top: 0, left: 0 } : n ? null : t.offset();
        const a = {
          scroll: i
  ...
  (function (s) {
    ...
    (n.VERSION = "3.4.1"),
      ...
      (n.prototype.refresh = function () {
        ...
        (this.offsets = []),
          ...
          this.$body
            ...
            .map(function () {
              const t = s(this);
              const e = t.data("target") || t.attr("href");
              const i = /^#./.test(e) && s(e);
              return (
      ...
      (n.prototype.process = function () {
        ...
        const o = this.options.offset + i - this.$scrollElement.height();
        const n = this.offsets;
      ...
      (n.prototype.activate = function (t) {
        ...
        const e =
          ...
          t +
          '"]';
        let i = s(e).parents("li").addClass("active");
  ...
  (function (r) {
    ...
    (a.VERSION = "3.4.1"),
      ...
      (a.prototype.show = function () {
        const t = this.element;
        const e = t.closest("ul:not(.dropdown-menu)");
        let i = t.data("target");
        if (
          ...
          const n = r.Event("hide.bs.tab", { relatedTarget: t[0] });
          const s = r.Event("show.bs.tab", { relatedTarget: o[0] });
          if (
            (o.trigger(n),
            t.trigger(s),
    ...
    (h.VERSION = "3.4.1"),
      ...
      (h.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
          ...
          let i = e.top;
          let o = e.bottom;
          const n = Math.max(l(document).height(), l(document.body).height());
