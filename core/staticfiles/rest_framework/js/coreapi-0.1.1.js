  ...
  })(
    {
            ...
            _createClass(Client, [
              {
                ...
                value: function action(document, keys) {
                  ...
                  const transport = utils.determineTransport(
                    this.transports,
                    link.url
                  );
          ...
          function primitiveToNode(data, baseUrl) {
            ...
            if (isObject && data._type === "document") {
              ...
              for (let idx = 0, len = fieldsData.length; idx < len; idx++) {
                ...
                const field = new document.Field(
                  name,
                  required,
                  location,
                  fieldDescription
      ...
      13: [
        function (require, module, exports) {
          ...
          const parseResponse = function parseResponse(
            response,
            decoders,
            responseCallback
          ) {
      ...
      15: [
        function (require, module, exports) {
          ...
          const determineTransport = function determineTransport(
            transports,
            url
          ) {
          ...
          const negotiateDecoder = function negotiateDecoder(
            decoders,
            contentType
          ) {
      ...
      19: [
        function (require, module, exports) {
          ...
          const lolcation = require("./lolcation");
      ...
      20: [
        function (require, module, exports) {
          (function (global) {
             ...
             * @return {Object} lolcation object.
             * @api public
             */
