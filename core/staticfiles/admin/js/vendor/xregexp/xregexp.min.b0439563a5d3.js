...
(function (H) {
  ...
  return (function c(d, g, p) {
    function A(l, b) {
      if (!g[l]) {
        if (!d[l]) {
          const k = "function" == typeof require && require;
          if (!b && k) return k(l, !0);
          if (B) return B(l, !0);
  ...
  })(
    {
      1: [
        function (d, g, p) {
          g.exports = function (c) {
            ...
            const z = /(\()(?!\?)|\\([1-9]\d*)|\\[\s\S]|\[(?:[^\\\]]|\\[\s\S])*\]/g;
            const l = c.union([/\({{([\w$]+)}}\)|{{([\w$]+)}}/, z], "g", {
              conjunction: "or",
            });
            c.build = function (b, k, g) {
              g = g || "";
              const y = -1 < g.indexOf("x");
              let m = /^\(\?([\w$]+)\)/.exec(b);
              ...
              let q = 0;
              const f = [0];
              const d = b.xregexp.captureNames || [];
        ...
        function (d, g, p) {
          g.exports = function (c) {
            ...
            c.matchRecursive = function (d, p, l, b, k) {
              b = b || "";
              k = k || {};
              const A = -1 < b.indexOf("g");
              const y = -1 < b.indexOf("y");
              let m = b.replace(/y/g, "");
              let h = k.escapeChar;
              k = k.valueNames;
              const w = [];
      ...
      9: [
        function (d, g, p) {
          ...
          const P = /\$(?:{([\w$]+)}|(\d\d?|[\s\S]))/g;
          const R = void 0 === n.exec.call(/()??/, "")[1];
          var Q = void 0 !== /x/.flags;
          var L = {}.toString;
          const M = c("u");
          const K = c("y");
          var N = { g: !0, i: !0, m: !0, u: M, y: K };
          f.prototype = RegExp();
          f.version = "3.2.0";
          f._clipDuplicates = B;
          f._hasNativeFlag = c;
          ...
          f.forEach = function (a, b, c) {
            for (let e = 0, d = -1; (e = f.exec(a, b, e)); )
          ...
          f.match = function (a, b, c) {
            const e = (b.global && "one" !== c) || "all" === c;
            let d = (e ? "g" : "") + (b.sticky ? "y" : "") || "noGY";
            b.xregexp = b.xregexp || {};
            d =
              b.xregexp[d] ||
              (b.xregexp[d] = z(b, {
          ...
          f.replace = function (a, b, c, d) {
            const e = f.isRegExp(b);
            const g = (b.global && "one" !== d) || "all" === d;
            const h = (g ? "g" : "") + (b.sticky ? "y" : "") || "noGY";
            let u = b;
            e
              ? ((b.xregexp = b.xregexp || {}),
                (u =
          ...
          r.exec = function (a) {
            const b = this.lastIndex;
            const c = n.exec.apply(this, arguments);
            let d;
            if (c) {
          ...
          r.match = function (a) {
            if (!f.isRegExp(a)) a = new RegExp(a);
              ...
              const b = n.match.apply(this, arguments);
              a.lastIndex = 0;
              return b;
            }
          ...
          f.addToken(
            /\\k<([\w$]+)>/,
            function (a) {
              const b = isNaN(a[1]) ? C(this.captureNames, a[1]) + 1 : +a[1];
              const c = a.index + a[0].length;
