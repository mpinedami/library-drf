  ...
  })(
    {
      1: [
        function (require, module, exports) {
          ...
          module.exports = function (XRegExp) {
             ...
             * @return {String} Pattern with edge anchors removed.
             */
             ...
             * @return {RegExp} XRegExp object with XRegExp syntax applied.
             */
             ...
             * @return {RegExp} Regex with interpolated subpatterns.
             * @example
             *
            ...
            XRegExp.build = function (pattern, subs, flags) {
              ...
              const output = patternAsRegex.source.replace(parts, function (
                $0,
                $1,
                $2,
                $3,
      ...
      2: [
        function (require, module, exports) {
          ...
          module.exports = function (XRegExp) {
             ...
             * @return {Array} Array of matches, or an empty array.
             * @example
             *
             * // Basic usage
             * var str = '(t((e))s)t()(ing)';
      ...
      9: [
        function (require, module, exports) {
           ...
           * @return {String} Either '' or '(?:)', depending on which is needed in the context of the match.
           */
           ...
           * @private
           * @param {RegExp} regex Regex to check.
           * @return {Boolean} Whether the regex uses named capture.
           */
           ...
           * @return {Number} Zero-based index at which the item is found, or -1.
           */
           ...
           * @return {Boolean} Whether the next nonignorable token matches `needlePattern`
           */
           ...
           * @return {Object} Object with properties `pattern` and `flags`.
           */
           ...
           * @return {Object} Object with properties `matchLength`, `output`, and `reparse`; or `null`.
           */
           ...
           *   `scope` is 'all'.
           * @return {String|Array} In match-first mode: First match as a string, or `null`. In match-all
