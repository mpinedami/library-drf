    ...
    return (
            ...
            for (const t in e) {
              ...
              if (1 !== n.length) {
                for (let r = 0; r < n.length; r++) {
                  let o = n[r];
                  (o = o.substring(0, 1).toLowerCase() + o.substring(1)) in i ||
                    (i[o] = {}),
          ...
          (i.prototype.bind = function (t, e) {
            ...
            this.$results.attr("id", n),
              ...
              t.on("results:previous", function () {
                const e = l.getHighlightedResults();
                const t = l.$results.find("[aria-selected]");
                const n = t.index(e);
                if (!(n <= 0)) {
                  let i = n - 1;
                  0 === e.length && (i = 0);
                  ...
                  const s = r.offset().top;
                  const a = l.$results.scrollTop() + (s - o);
                  0 === i
              ...
              t.on("results:next", function () {
                ...
                if (!(n >= t.length)) {
                  ...
                  const o = i.offset().top + i.outerHeight(!1);
                  const s = l.$results.scrollTop() + o - r;
                  0 === n
                    ? l.$results.scrollTop(0)
              ...
              h.fn.mousewheel &&
                this.$results.on("mousewheel", function (e) {
                  ...
                  const i = 0 < e.deltaY && t - e.deltaY <= 0;
            ...
            (n.prototype.update = function (e) {
              if ((this.clear(), 0 !== e.length)) {
                for (var t = [], n = 0; n < e.length; n++) {
                  const i = e[n];
                  const r = this.selectionContainer();
                  const o = this.display(i, r);
                  r.append(o);
                  const s = i.title || i.text;
                  s && r.attr("title", s),
                ...
                this.$selection.on(
                  ...
                  function (e) {
                    if (
                      ...
                      const t = i.$searchContainer.prev(
      ...
      e.define("select2/dropdown/attachBody", ["jquery", "../utils"], function (
        ...
        return (
          ...
          (e.prototype._attachPositioningHandler = function (e, t) {
            ...
            const s = this.$container.parents().filter(a.hasScroll);
            s.each(function () {
          ...
          (e.prototype._positionDropdown = function () {
            ...
            const c = a < r.top - s;
            const u = l > r.bottom + s;
            const d = { left: r.left, top: o.bottom };
            ...
            (n.prototype.apply = function (e) {
              ...
              if (
                ...
                if (
                  ...
                  const r = u(e.amdBase + "compat/dropdownCss");
        ...
        function (i, d, r, p) {
          function e(e, t) {
            if (
              ...
              const n = i(this.get("amdBase") + "compat/inputData");
          ...
          return (
            ...
            (d.prototype.trigger = function (e, t) {
              ...
              if ((void 0 === t && (t = {}), e in i)) {
                const r = i[e];
                const o = { prevented: !1, name: e, args: t };
      ...
      e.define("select2/compat/containerCss", ["jquery", "./utils"], function (
        ...
        return (
          (e.prototype.render = function (e) {
            const t = e.call(this);
            let n = this.options.get("containerCssClass") || "";
            s.isFunction(n) && (n = n(this.$element));
            let i = this.options.get("adaptContainerCssClass");
            ...
            let o = this.options.get("containerCss") || {};
            return (
      ...
      e.define("select2/compat/dropdownCss", ["jquery", "./utils"], function (
        ...
        return (
          (e.prototype.render = function (e) {
            ...
            s.isFunction(n) && (n = n(this.$element));
            let i = this.options.get("adaptDropdownCssClass");
            if (((i = i || l), -1 !== n.indexOf(":all:"))) {
              n = n.replace(":all:", "");
              const r = i;
              i = function (e) {
            ...
            let o = this.options.get("dropdownCss") || {};
            return (
              s.isFunction(o) && (o = o(this.$element)),
              a.syncCssClasses(t, this.$element, i),
              t.css(o),
        ...
        return (
          ...
          (e.prototype.query = function (e, t, n) {
            for (var i = [], r = 0; r < this._currentData.length; r++) {
              const o = this._currentData[r];
              const s = this.matches(t, o);
              null !== s && i.push(s);
            }
            n({ results: i });
          }),
          (e.prototype.addOptions = function (e, t) {
            const n = s.map(t, function (e) {
      ...
      e.define("select2/compat/matcher", ["jquery"], function (s) {
        return function (o) {
          return function (e, t) {
            const n = s.extend(!0, {}, t);
            if (null == e.term || "" === s.trim(e.term)) return n;
            if (t.children) {
              for (let i = t.children.length - 1; 0 <= i; i--) {
      ...
      (l = function (p) {
        ...
        var m = (p.event.special.mousewheel = {
          ...
          setup: function () {
            if (this.addEventListener)
              for (let e = t.length; e; ) this.addEventListener(t[--e], i, !1);
          ...
          getLineHeight: function (e) {
            const t = p(e);
            let n = t["offsetParent" in p.fn ? "offsetParent" : "parent"]();
            return (
              n.length || (n = p("body")),
        ...
        function i(e) {
          ...
          if (
            ...
            if (1 === n.deltaMode) {
              const c = p.data(this, "mousewheel-line-height");
              (r *= c), (s *= c), (o *= c);
            } else if (2 === n.deltaMode) {
              const u = p.data(this, "mousewheel-page-height");
              (r *= u), (s *= u), (o *= u);
            }
            if (
